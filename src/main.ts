...
program.command('commit')
    ...
    .addOption(new Option('--dry-run', 'Perform a dry run without executing any commands.').conflicts(['add', 'push']))
    .addOption(new Option('-r, --retry', 'Retry the last commit.'))
    .addOption(new Option('-c, --copy', 'Copy the commit message to your clipboard instead of committing.').conflicts('push'))
